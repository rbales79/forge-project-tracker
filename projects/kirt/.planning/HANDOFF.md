...
### Persona 1: Elena, Enterprise Architect

**Context:** Strategic account lead. Manages 8-12 named enterprise accounts. Follows the SAF for strategic accounts but needs to move fast.

**Core tasks:**
- Run Account Brief for a specific account before exec meeting (R19, R20, R21, R22)
- Build Engagement Prep package including discovery questions mapped to offerings (R24, R25, R26)
- Upload meeting notes → extract signals, update account intelligence (R13, R28, R29)
- Track SAF progress as an optional overlay, not as forced workflow (R44)
- Review white space analysis to identify cross-sell opportunities (R34, R35)

**Key pain points:** Document preparation takes hours before each engagement. Account intelligence is scattered across SharePoint, email, and tribal knowledge.

### Persona 2: Marcus, Account Executive

**Context:** Owns 20-30 accounts. No SAF methodology. Needs fast, practical output before meetings.

**Core tasks:**
- Prep for a meeting in 10 minutes: search account, get Engagement Prep (R05, R06, R24)
- Upload rough meeting notes, get polished summary + draft follow-up email (R28, R29, R30)
- Generate client deliverable from company name + keywords (R31, R32, R33)
- Search for relevant documents across all accounts (R05, R06, R07, R08)

**Key pain points:** No time for frameworks. Needs something sendable in minutes, not hours. Current state: Google search + memory + whatever's on SharePoint.

### Persona 3: Sarah, Sales Director

**Context:** Leads a team of 15 AEs and EAs. Needs visibility, not control.

**Core tasks:**
- Search for account intelligence on any account (R05, R08, R09)
- View Account Brief for any account (R19, R20)
- See data freshness: what's current, what's stale (R11)
- Access generated deliverables and source documents (R09, R23)

**Key pain points:** No unified view of account intelligence. Relies on AEs and EAs to brief her. Knowledge walks out the door when people leave.
...
**Revenue intelligence (Gong, Clari, People.ai):** Focus on call recording, pipeline prediction, and structured CRM data. Don't process internal SP documents or generate written deliverables. Strong complement, not a replacement.

**Sales enablement (Seismic, Highspot):** Content management and delivery for sales reps. Don't generate account-specific intelligence or integrate deeply with the org's unstructured data. KIRT generates where they organize.

**Account intelligence (ZoomInfo, 6sense, Demandbase):** Public data aggregators. No internal document analysis. No deliverable generation. KIRT complements them (public data enriches KIRT's output) rather than replacing them.

**Microsoft Copilot for Sales:** Closest analog in terms of M365 integration, but generic AI assistant without strategic account framework, scoring, or Foundation-layer data normalization.

### Positioning Statement
> KIRT turns the organization's own knowledge — documents, meeting notes, SF records, public filings — into structured account intelligence and client-ready deliverables. In 10 minutes, not 4 hours.
